...
foreach my $f (@names){   		
	...
	system "./samtools view -u $outputPrefix.sorted.bam | ./samtools mpileup -vcf $prgSeqName -> raw_$outputPrefix.txt";
	system "./samtools mpileup -f $prgSeqName $outputPrefix.sorted.bam >$outputPrefix.pileup";
