...
"Minimum overlapping sequence to cluster reads into alleles or loci (100 for 454 data, 50 for Illumina): ";
This tells CAP3 the minimum number of overlapping bases needed to put sequences in the same cluster. If the number is too low, you might get really divergent reads contig-ed together.

“Minimum coverage for calling consensus in an individual (6):”
